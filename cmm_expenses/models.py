...
COMPANY_NAME = "THE CMM CHRONOS LIMITED"
...
class ProjectRecord(models.Model):
    ...
    tax_type = models.CharField(max_length=10, choices=TAX_CHOICES, default="NONE")
    ...
    def expense_value(self):
        return sum((expense.amount for expense in self.expenses.all()), Decimal("0.00"))
    ...
    def __str__(self):
        return f"{COMPANY_NAME} - {self.project_supply}"
...
class PendingProjectRecord(models.Model):
    ...
    contract_value = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    tax_type = models.CharField(max_length=10, choices=ProjectRecord.TAX_CHOICES, default="NONE")
